...
import { createHospital } from "../../services/hospitals.api"; // Ajuste o caminho conforme necessário
...
const CadastroHospitais = () => {
  ...
  return (
    <div>
      <div className="header">Cadastro de Hospitais</div>
      <main>
        <Formik
        ...
        >
          {({ isSubmitting }) => (
            <Form className="register-form">
              ...
              <Field type="text" id="telefone" name="telefone" className="input" placeholder="Digite apenas números" />
              <ErrorMessage name="telefone" component="div" className="error-message" />

              <label htmlFor="email">Email:</label>
              <Field type="email" id="email" name="email" className="input" placeholder="email@exemplo.com" />
              ...
              <fieldset className="endereco-fieldset">
                ...
                <Field type="text" id="endereco.rua" name="endereco.rua" className="input" placeholder="Nome da rua" />
                <ErrorMessage name="endereco.rua" component="div" className="error-message" />

                <label htmlFor="endereco.complemento">Complemento:</label>
                <Field type="text" id="endereco.complemento" name="endereco.complemento" className="input" placeholder="Complemento (opcional)" />
                <ErrorMessage name="endereco.complemento" component="div" className="error-message" />

                <label htmlFor="endereco.bairro">Bairro:</label>
                <Field type="text" id="endereco.bairro" name="endereco.bairro" className="input" placeholder="Nome do bairro" />
                <ErrorMessage name="endereco.bairro" component="div" className="error-message" />

                <label htmlFor="endereco.cep">CEP:</label>
                <Field type="text" id="endereco.cep" name="endereco.cep" className="input" placeholder="Digite apenas números" />
                <ErrorMessage name="endereco.cep" component="div" className="error-message" />

                <label htmlFor="endereco.cidade">Cidade:</label>
                <Field type="text" id="endereco.cidade" name="endereco.cidade" className="input" placeholder="Nome da cidade" />
                <ErrorMessage name="endereco.cidade" component="div" className="error-message" />

                <label htmlFor="endereco.estado">Estado:</label>
                <Field type="text" id="endereco.estado" name="endereco.estado" className="input" placeholder="UF" maxLength={2} />
